...
description: "Our agnostic architecture ensures data sovereignty and integration with public foundational models like ALIA or AINA."
sidebar:
  order: 101
---
...
### Integration with Public Initiatives (ALIA, AINA)
...
Foundational projects like **ALIA** (for the development of models in Spanish and co-official languages) and **AINA** (for Catalan) represent exactly the type of sovereign infrastructure on which ColabEdu is designed to operate.
...
1. **ALIA/AINA Validation in Assessment:** Demonstrate how a public foundational model can execute complex OAS standard rubrics with the same or greater pedagogical accuracy than commercial corporate models.
